...
@dataclass
class ELLISAdamArguments:
    """
    Arguments pertaining to the ELLISAdam optimizer.
    """
    use_ellisadam: bool = field(
        default=False,
        metadata={"help": "Whether or not to use the ELLISAdam optimizer."},
    )
    update_clipping: bool = field(
        default=True,
        metadata={"help": "Whether to use update clipping in ELLISAdam."},
    )
    atan_adam: bool = field(
        default=True,
        metadata={"help": "Whether to use atan_adam mode in ELLISAdam."},
    )
    running_init: bool = field(
        default=True,
        metadata={"help": "Whether to use running_init in ELLISAdam."},
    )
    tensor_wise_finite_check: bool = field(
        default=False,
        metadata={"help": "Whether to perform tensor-wise finite check in ELLISAdam."},
    )
    tensor_wise_gradient_normalization: bool = field(
        default=False,
        metadata={"help": "Whether to use tensor-wise gradient normalization in ELLISAdam."},
    )
    decouple_wd: bool = field(
        default=True,
        metadata={"help": "Whether to use decoupled weight decay in ELLISAdam."},
    )
    # buffer_dtype: Optional[str] = field(
    #     default=None,
    #     metadata={"help": "Buffer dtype to use in ELLISAdam (bf16, f16, etc.)."},
    # )
    # eps_adjustment: bool = field(
    #     default=False,
    #     metadata={"help": "Whether to use epsilon adjustment in ELLISAdam."},
    # )
    # kahan_sum_compensation: bool = field(
    #     default=False,
    #     metadata={"help": "Whether to use Kahan sum compensation in ELLISAdam."},
    # )
    # adafactor_like_beta_corrections: bool = field(
    #     default=False,
    #     metadata={"help": "Whether to use Adafactor-like beta corrections in ELLISAdam."},
    # )


@dataclass
class FinetuningArguments(
    FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument, SwanLabArguments, ELLISAdamArguments
):
    r"""
