...
def get_param_groups(
    ...
    for name, param in named_parameters:
        lname = name.lower()
        if "wte" in lname or "embed" in lname or "abacus" in lname or "lm_head" in lname:
        ...
        elif "dense" in lname or "query_key_value" in lname or "fc" in lname or param.ndim == 2:
