#!/bin/bash
# mHC residual-stream baseline on Llama-410M-class GQA4x config.

set -e

cd "$(dirname "$0")/.."

OUTPUT_DIR=${OUTPUT_DIR:-saves/smallpile/baseline_mhc_410m}
MODEL_CFG=${MODEL_CFG:-llama_config/baseline_mhc_410m}
