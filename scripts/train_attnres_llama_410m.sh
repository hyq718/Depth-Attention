#!/bin/bash
# Block AttnRes baseline on Llama-410M-class GQA4x config.

set -e

cd "$(dirname "$0")/.."

OUTPUT_DIR=${OUTPUT_DIR:-saves/smallpile/baseline_attnres_410m}
MODEL_CFG=${MODEL_CFG:-llama_config/baseline_attnres_410m}
